...
export function DashboardPage() {
  ...
  // Widget visibility preferences from localStorage (Change 6)
  ...
  // Monthly Expenses Metrics (Change 3: Total Amount & Total Spent ONLY)
  ...
  // Habit Tracker Performance Metrics (Change 4: Performance Overview ONLY)
  const totalHabitCount = routines ? routines.length : 3;
  const habitChecksDone = 18; // Week sample check count
  ...
  return (
    <div className="page-container">
      ...
      <div className="grid-2" style={{ alignItems: 'start' }}>
        ...
        {/* MONTHLY EXPENSES Card (Change 3: ONLY Total Amount + Total Spent) */}
        {widgetSettings.expense && (
          <div className="glass-card">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 'var(--space-xs)', marginBottom: '14px', textAlign: 'center' }}>
              <div style={{ padding: '10px', borderRadius: 'var(--radius-sm)', background: 'var(--bg-secondary)' }}>
      ...
      {/* Row 2: MEMORY PERFORMANCE (Left) | HABIT TRACKER (Right) */}
      <div className="grid-2" style={{ alignItems: 'start' }}>
        ...
        {/* HABIT TRACKER PERFORMANCE WIDGET (Change 4) */}
        {widgetSettings.habit && (
          <div className="glass-card">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 'var(--space-md)' }}>
              <h3 style={{ color: 'var(--accent-primary)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Activity size={18} color="var(--accent-primary)" /> HABIT TRACKER
              </h3>
              <Link to="/app/habits" style={{ fontSize: '12px', fontWeight: '700', color: 'var(--accent-primary)', display: 'flex', alignItems: 'center', gap: '4px', textDecoration: 'none' }}>
            ...
            <div style={{ fontSize: '12px', color: 'var(--text-secondary)', background: 'var(--bg-secondary)', padding: '10px 12px', borderRadius: 'var(--radius-sm)', display: 'flex', justifyContent: 'space-between' }}>
              <span>Top Habit:</span>
